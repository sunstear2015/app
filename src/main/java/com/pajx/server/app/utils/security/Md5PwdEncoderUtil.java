...
public class Md5PwdEncoderUtil {
	...
	public String getMD5Content(String inbuf) {
		md5Init();
	...
	public String changeContent(String input) {
		int len = input.length();
		String first = input.substring(0, len / 2);
		String second = input.substring(len / 2, len);
		String nstr = second + first;
	...
	public static String cardEncrytion(String schoolNum) {
		...
		sb.append(md5Content.substring(0, 3));
		sb.append(md5Content.substring(6, 12));
		sb.append(md5Content.substring(18, 21));
